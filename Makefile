...
chrononaut.o: chrononaut.cpp chrononaut.h const.h populationCentre.h artifact.h event.h
...
findArtifact.o: findArtifact.cpp findArtifact.h artifact.h chrononaut.h const.h populationCentre.h handlingData.h randoms.h
	$(CCC) $(CCFLAGS) -c findArtifact.cpp
event.o: event.cpp event.h const.h populationCentre.h randoms.h
